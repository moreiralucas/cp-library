...
\section{Template}{
  \subsection{Código do Template}{
    \includecode{extras/template.cpp}
  }
  \subsection{Script de submissão}{
    \includecode{extras/g11.sh}
  }
  \subsection{Script em python}{
    \includecode{extras/python.py}
  }
}

\section{Matemática}{
  \subsection{Geometria}{
    \includecode{geometry/geo.cpp}
  }
  \subsection{Exponenciação}{
    \includecode{math/exp.cpp}
  }
  \subsection{Divisores}{
    \includecode{math/divisores.cpp}
  }
  \subsection{Permutações}{
    \includecode{math/math.cpp}
  }
}

\section{Grafos}{
  \subsection{Componentes fortemente conexas (SCC)}{
  ...
  \subsection{Dijkstra (Caminhos mínimos)}{
    \includecode{graphs/dijkstra.cpp}
  }
  \subsection{Fluxo}{
    \includecode{graphs/fluxo.cpp}
  }
  \subsection{DisjointSet}{
    \includecode{graphs/disjointSet.cpp}
  }
}
...
\section{Programação dinâmica}{
  ...
  \subsection{Moedas}{
    \includecode{dp/moedas.cpp}
  }
  \subsection{Troco}{
    \includecode{dp/troco.cpp}
  }
  \subsection{Segtree}{
    \includecode{dp/segtree.cpp}
  }
}
